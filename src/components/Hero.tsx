  ...
  return (
    <section className="hero" aria-label="Introduction">
      <div className="hero-full">
        ...
        />
        {/* Glass panels — text stays readable on full image */}
        ...
        <div className="hero-glass hero-glass--headline">
          ...
          <h1 className="hero-title">
            I build <strong>systems</strong>
            <br />
            that make complexity usable.
          </h1>
        </div>

        <div className="hero-glass hero-glass--bottom-left">
        ...
        <div className="hero-glass hero-glass--bottom-right">
